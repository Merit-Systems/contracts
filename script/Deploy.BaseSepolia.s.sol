...
contract DeployBaseSepolia is Script {
  uint constant AMOUNT_TO_MINT = 100_000_000 * 10**6;
    ...
    function run() public {
      ...
      mockUSDC.mint(Params.BASESEPOLIA_TESTER,       AMOUNT_TO_MINT);
      mockUSDC.mint(Params.BASESEPOLIA_TESTER_JSON,  AMOUNT_TO_MINT);
      mockUSDC.mint(Params.BASESEPOLIA_TESTER_SHAFU, AMOUNT_TO_MINT);

      vm.stopBroadcast();

      address[] memory initialWhitelistedTokens = new address[](3);
      initialWhitelistedTokens[0] = Params.BASESEPOLIA_WETH;
      initialWhitelistedTokens[1] = Params.BASESEPOLIA_USDC;
